...
import (
	...
	"source.developers.google.com/p/sotah-prod/r/steamwheedle-cartel.git/pkg/sotah/codes"
)

func (sta WorkloadState) ResolveRealm(tuple sotah.RegionRealmTuple) (sotah.Realm, error) {
...
func (sta WorkloadState) DownloadAuctions(tuple sotah.RegionRealmTuple) sotah.Message {
	realm, err := sta.ResolveRealm(tuple)
	if err != nil {
