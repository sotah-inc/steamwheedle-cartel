...
func DefaultGetItemClassIndexURL(regionHostname string) string {
	return fmt.Sprintf(itemClassIndexURLFormat, regionHostname)
}

type GetItemClassIndexURLFunc func(string) string
