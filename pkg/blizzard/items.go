...
import (
	...
	"source.developers.google.com/p/sotah-prod/r/steamwheedle-cartel.git/pkg/blizzard/itembinds"
...
type Item struct {
	...
	ItemClass      ItemClassId        `json:"itemClass"`
	ItemSubClass   ItemSubClassId     `json:"itemSubClass"`
